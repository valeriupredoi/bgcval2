# -*- coding: utf-8 -*-
#
# BGCVal2 documentation build configuration file, created by
...
from bgcval2._version import __version__
...
project = u'BGCVal2'
copyright = u'{0}, BGCVal2 Development Team'.format(datetime.now().year)
...
html_short_title = "BGCVal2 {0}".format(release)
...
latex_elements = {
   ...
   \renewcommand{\maketitle}{
     ...
     \begin{titlepage}
     \begin{center}
     \includegraphics[width=\textwidth]{figures/BGCVal2-logo-2.pdf}\par
     \vspace{2cm}
...
latex_documents = [
    ('index', 'BGCVal2_Users_Guide.tex',
     u'BGCVal2 User\'s and Developer\'s Guide',
     u'BGCVal2 Development Team', 'manual'),
]
...
# texinfo_documents = [
#  ('index', 'BGCVal2', u'BGCVal2 Documentation',
...
epub_title = u'BGCVal2'
epub_author = u'BGCVal2 Development Team'
epub_publisher = u'BGCVal2 Development Team'
epub_copyright = u'BGCVal2 Development Team'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'BGCVal2'
...
intersphinx_mapping = {
    # 'esmvalcore':
    # (f'https://docs.bgcval2.org/en/{rtd_version}/',
    #  None),
